...
let ProductsController = class ProductsController {
    ...
    create(createProductDto, req) {
        if (req.user.role !== 'admin') {
            throw new common_1.ForbiddenException('Solo los administradores pueden crear productos');
        }
        return this.productsService.create(createProductDto);
    }
    update(id, updateProductDto, req) {
        if (req.user.role !== 'admin') {
            throw new common_1.ForbiddenException('Solo los administradores pueden actualizar productos');
        }
